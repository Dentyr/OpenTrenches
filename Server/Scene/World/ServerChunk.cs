...
/// </summary>
public class ServerChunk : ITileChunk
{
    ...
    public ServerChunk(TileType[][] tiles, IEnumerable<TileConstructionRecord> constructions)
    {
    ...
    public ServerChunk(Func<int, int, TileType> Initializer)
    {
