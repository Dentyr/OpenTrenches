...
public interface ICharacterAdapter
{
    ...
    FireHitResult AdaptFire(WorldLayer channel, Vector2 target);
    /// <summary>
    ...
    //TODO combine character adapter with world adapter into single character simulation context, and move there
    void AdaptStrike(Vector2 location);
}
